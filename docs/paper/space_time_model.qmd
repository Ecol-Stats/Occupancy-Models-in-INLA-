...
d0 = data.frame(time = time,
                m1 = apply(det1  , 1,mean),
                q11 = apply(det1  , 1,quantile, 0.05),
                q12 = apply( det1  , 1,quantile, 0.95),
                
                 m2 = apply( det2  , 1,mean),
                q21 = apply( det2  , 1,quantile, 0.05),
                q22 = apply( det2  , 1,quantile, 0.95),
               
                m3 = apply( det3  , 1,mean),
                q31 = apply( det3  , 1,quantile, 0.05),
                q32 = apply( det3  , 1,quantile, 0.95))
       d0 %>% ggplot() + 
         geom_line(aes(time, m1, color = "model1"))  + 
         geom_line(aes(time, m2, color = "model2"))  + 
         geom_line(aes(time, m3, color = "model3"))   
  
       
       
       d0 %>%  ggplot() + geom_ribbon(aes(time, ymin = q11, ymax = q12), alpha = 0, color = "red") +
   geom_ribbon(aes(time, ymin = q21, ymax = q22), alpha = 0, color = "blue") +
   geom_ribbon(aes(time, ymin = q31, ymax = q32), alpha = 0, color = "black")       
...
revi.sp.det.formula <- ~ scale(day) + I(scale(day^2)) 
