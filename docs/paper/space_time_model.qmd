...
elev_raster22 = resample(elev_raster, raster(nrows=100, ncols=100, 
                                             xmn=274, xmx=284,
                                             ymn=4866, ymx=4872, 
                                             vals=NULL))
values(elev_raster22) <- (values(elev_raster22^2) - 
                            mean(revi.data$occ.covs$elev^2)) / 
  sd(revi.data$occ.covs$elev^2)
...
pred_df = data.frame(x = rep(coordinates(elev_raster2)[,1],9),
                     ...
                     scale_elev2 = rep(values(elev_raster2),9),
