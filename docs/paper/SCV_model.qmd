...
dd = data.frame(x = coords.0[,1],
  ...
  mutate(check1 = case_when(z1_2<0 ~ -1,
                            z1_1>0 ~ 1,
                            z1_1<=0 & z1_2>=0 ~ 0),
         check2 = case_when(z2_2<0 ~ -1,
                            z2_1>0 ~ 1,
                            z2_1<=0 & z2_2>=0 ~ 0),
         check3 = case_when(z3_2<0 ~ -1,
                            z3_1>0 ~ 1,
                            z3_1<=0 & z3_2>=0 ~ 0) )
...
pred.stars.long = dd |> dplyr::select(c(x,y,z1,z1,z1,check1,check2,check3)) |> gather(key="model",value="dens",3:5) |>  st_as_stars(dims = c('x', 'y'))
