...
This code reproduces the case study ""
"Spatio-temporal Occupancy Models with INLA". The dataset and part of the code for preparing the data, is taken from the supplementary material of the paper @Dose
