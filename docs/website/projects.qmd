...
y_data = data.frame(y = y.mat , cellid = site_id, nvisits = nvisits.mat)

Occ_data_2 <- left_join(Occ_data_2,y_data,by = "cellid")
...
Occ_data_3 <- left_join(Occ_data_3,y_data,by = "cellid")
