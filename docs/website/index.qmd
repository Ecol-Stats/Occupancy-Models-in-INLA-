...
::: callout-note
Recall the because of iINLA's likelihood parametrization of a ZIB-model we defined $\mathrm{logit}(\psi_{i,t}) =  -\eta_1 = -\left[\beta_0 + f_1(x_i) + \omega(i,t) \right]$
:::
...
download_link(
  link = "https://github.com/Ecol-Stats/Occupancy-Models-in-INLA-/blob/main/docs/website/raster%20data/spatsat_occ_probs.tif/spatsat_occ_probs.tif",
...
```{r}
download_link(
  link = "https://github.com/Ecol-Stats/Occupancy-Models-in-INLA-/blob/main/docs/website/raster%20data/spatio_svc_probs.tif/spatio_svc_probs.tif",
  button_label = "Download simulated example",
  button_type = "info",
  has_icon = TRUE,
  icon = "fa fa-save",
